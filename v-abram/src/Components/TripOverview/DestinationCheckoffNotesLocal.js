...
import { Train, Hotel, BusinessCenter } from '@material-ui/icons/';
...
function CheckOffNotesLocal (props) {
  const { classes } = props;

  return (
    <React.Fragment>
      <Tooltip title="Bus/Train booked?">
        <Checkbox
          checked={false}
          icon={<Train />}
          // onChange={}
...
export default withStyles(styles, { withTheme: true })(CheckOffNotesLocal);
