  ...
  render() {
    ...
    const AddDayCol = {
      ...
      options: {
        ...
        customBodyRender: (value, tableMeta, updateValue) => {
          return value ? (
            <IconButton onClick={() => this.props.addDay({ k: value })}>
              <Add />
            </IconButton>
          ) : null;
        },
    ...
    // add column
    if (typeof TripOverviewAddDayButton === 'undefined') {
      window.TripOverviewAddDayButton = true;
      columns.splice(5, 0, AddDayCol);
    }
    ...
    const RemoveDayCol = {
      ...
      options: {
        ...
        customBodyRender: (value, tableMeta, updateValue) => {
          return value ? (
            <IconButton onClick={() => this.props.removeDay({ k: value })}>
              <Remove />
            </IconButton>
          ) : null;
        },
    ...
    if (typeof TripOverviewRemoveDayButton === 'undefined') {
      window.TripOverviewRemoveDayButton = true;
      columns.splice(4, 0, RemoveDayCol);
    }
    ...
    const RemoveDestCol = {
      ...
      options: {
        ...
        customBodyRender: (value, tableMeta, updateValue) => {
          return value ? (
            <IconButton onClick={() => this.props.removeDestination({ k: value })}>
              <RemoveCircleOutline />
            </IconButton>
          ) : null;
        },
    ...
    if (typeof TripOverviewRemoveDestButton === 'undefined') {
      window.TripOverviewRemoveDestButton = true;
      columns.push(RemoveDestCol);
    }
            ...
            title={
              <React.Fragment>
                ...
                <div style={{ fontSize: 'small', color: 'grey' }}>
                  {getFormatDate(this.props.prefs.startTripDate)} to{' '}
                  {getFormatDate(this.props.prefs.endTripDate)}
                </div>
              </React.Fragment>
            }
